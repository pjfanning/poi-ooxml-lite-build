...
public class CTSlideLayoutIdListEntryImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.presentationml.x2006.main.CTSlideLayoutIdListEntry {
    ...
    public org.openxmlformats.schemas.presentationml.x2006.main.STSlideLayoutId xgetId() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.presentationml.x2006.main.STSlideLayoutId)get_store().find_attribute_user(PROPERTY_QNAME[1]);
            return target;
        }
    }
    ...
    public void xsetId(org.openxmlformats.schemas.presentationml.x2006.main.STSlideLayoutId id) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.presentationml.x2006.main.STSlideLayoutId)get_store().find_attribute_user(PROPERTY_QNAME[1]);
            if (target == null) {
                target = (org.openxmlformats.schemas.presentationml.x2006.main.STSlideLayoutId)get_store().add_attribute_user(PROPERTY_QNAME[1]);
            }
            target.set(id);
        }
    }
