...
public class CTMeasureGroupsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMeasureGroups {
    ...
    private static final QName[] PROPERTY_QNAME = {
        new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "measureGroup"),
        new QName("", "count"),
    };
    ...
    public java.util.List<org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMeasureGroup> getMeasureGroupList() {
        synchronized (monitor()) {
            ...
            return new org.apache.xmlbeans.impl.values.JavaListXmlObject<>(
                this::getMeasureGroupArray,
                this::setMeasureGroupArray,
                this::insertNewMeasureGroup,
                this::removeMeasureGroup,
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMeasureGroup[] getMeasureGroupArray() {
        return getXmlObjectArray(PROPERTY_QNAME[0], new org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMeasureGroup[0]);
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMeasureGroup getMeasureGroupArray(int i) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMeasureGroup)get_store().find_element_user(PROPERTY_QNAME[0], i);
            if (target == null) {
    ...
    /**
     * Sets array of all "measureGroup" element  WARNING: This method is not atomicaly synchronized.
     */
    @Override
    public void setMeasureGroupArray(org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMeasureGroup[] measureGroupArray) {
        check_orphaned();
        arraySetterHelper(measureGroupArray, PROPERTY_QNAME[0]);
    }
    ...
    public void setMeasureGroupArray(int i, org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMeasureGroup measureGroup) {
        generatedSetterHelperImpl(measureGroup, PROPERTY_QNAME[0], i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMeasureGroup insertNewMeasureGroup(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMeasureGroup target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMeasureGroup)get_store().insert_element_user(PROPERTY_QNAME[0], i);
            return target;
        }
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMeasureGroup addNewMeasureGroup() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMeasureGroup target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMeasureGroup)get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
