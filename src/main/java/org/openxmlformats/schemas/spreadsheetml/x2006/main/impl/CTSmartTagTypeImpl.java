...
public class CTSmartTagTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.spreadsheetml.x2006.main.CTSmartTagType {
     ...
     */
    @Override
    public org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring xgetNamespaceUri() {
        synchronized (monitor()) {
            check_orphaned();
     ...
     */
    @Override
    public void xsetNamespaceUri(org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring namespaceUri) {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring target = null;
            target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring)get_store().find_attribute_user(PROPERTY_QNAME[0]);
