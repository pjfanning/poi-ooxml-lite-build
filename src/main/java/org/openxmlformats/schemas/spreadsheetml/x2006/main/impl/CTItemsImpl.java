...
public class CTItemsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.spreadsheetml.x2006.main.CTItems {
    ...
    private static final QName[] PROPERTY_QNAME = {
        new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "item"),
        new QName("", "count"),
    };
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTItem[] getItemArray() {
        return getXmlObjectArray(PROPERTY_QNAME[0], new org.openxmlformats.schemas.spreadsheetml.x2006.main.CTItem[0]);
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTItem getItemArray(int i) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTItem)get_store().find_element_user(PROPERTY_QNAME[0], i);
            if (target == null) {
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTItem insertNewItem(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTItem target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTItem)get_store().insert_element_user(PROPERTY_QNAME[0], i);
            return target;
        }
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTItem addNewItem() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTItem target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTItem)get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
