...
public class CTDdeItemImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDdeItem {
    ...
    private static final QName[] PROPERTY_QNAME = {
        new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "values"),
        new QName("", "name"),
        new QName("", "ole"),
        new QName("", "advise"),
        new QName("", "preferPic"),
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDdeValues getValues() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDdeValues)get_store().find_element_user(PROPERTY_QNAME[0], 0);
    ...
    public void setValues(org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDdeValues values) {
        generatedSetterHelperImpl(values, PROPERTY_QNAME[0], 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDdeValues addNewValues() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDdeValues target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDdeValues)get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
    ...
    public org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring xgetName() {
        synchronized (monitor()) {
            ...
            if (target == null) {
                target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring)get_default_attribute_value(PROPERTY_QNAME[1]);
            }
            return target;
        }
    }
