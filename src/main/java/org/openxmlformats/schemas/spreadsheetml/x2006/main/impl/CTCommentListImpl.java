...
public class CTCommentListImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.spreadsheetml.x2006.main.CTCommentList {
    ...
    private static final QName[] PROPERTY_QNAME = {
        new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "comment"),
    };
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTComment[] getCommentArray() {
        return getXmlObjectArray(PROPERTY_QNAME[0], new org.openxmlformats.schemas.spreadsheetml.x2006.main.CTComment[0]);
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTComment getCommentArray(int i) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTComment)get_store().find_element_user(PROPERTY_QNAME[0], i);
            if (target == null) {
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTComment insertNewComment(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTComment target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTComment)get_store().insert_element_user(PROPERTY_QNAME[0], i);
            return target;
        }
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTComment addNewComment() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTComment target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTComment)get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
