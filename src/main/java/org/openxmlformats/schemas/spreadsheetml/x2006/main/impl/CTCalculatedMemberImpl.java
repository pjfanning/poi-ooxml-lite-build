...
public class CTCalculatedMemberImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.spreadsheetml.x2006.main.CTCalculatedMember {
    ...
    private static final QName[] PROPERTY_QNAME = {
        ...
        new QName("", "name"),
        new QName("", "mdx"),
        new QName("", "memberName"),
        new QName("", "hierarchy"),
        new QName("", "parent"),
        new QName("", "solveOrder"),
        new QName("", "set"),
    };
     ...
     */
    @Override
    public org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring xgetMemberName() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring target = null;
     ...
     */
    @Override
    public void xsetMemberName(org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring memberName) {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring target = null;
            target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring)get_store().find_attribute_user(PROPERTY_QNAME[3]);
     ...
     */
    @Override
    public org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring xgetHierarchy() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring target = null;
     ...
     */
    @Override
    public void xsetHierarchy(org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring hierarchy) {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring target = null;
            target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring)get_store().find_attribute_user(PROPERTY_QNAME[4]);
    ...
    public org.apache.xmlbeans.XmlInt xgetSolveOrder() {
        synchronized (monitor()) {
            ...
            if (target == null) {
                target = (org.apache.xmlbeans.XmlInt)get_default_attribute_value(PROPERTY_QNAME[6]);
            }
            return target;
        }
    }
