...
public class CTBordersImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorders {
    ...
    public java.util.List<org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorder> getBorderList() {
        synchronized (monitor()) {
            ...
            return new org.apache.xmlbeans.impl.values.JavaListXmlObject<>(
                this::getBorderArray,
                this::setBorderArray,
                this::insertNewBorder,
                this::removeBorder,
                this::sizeOfBorderArray
            );
        }
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorder[] getBorderArray() {
        return getXmlObjectArray(PROPERTY_QNAME[0], new org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorder[0]);
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorder getBorderArray(int i) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorder)get_store().find_element_user(PROPERTY_QNAME[0], i);
            if (target == null) {
    ...
    /**
     * Sets array of all "border" element  WARNING: This method is not atomicaly synchronized.
     */
    @Override
    ...
    public void setBorderArray(int i, org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorder border) {
        generatedSetterHelperImpl(border, PROPERTY_QNAME[0], i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorder insertNewBorder(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorder target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorder)get_store().insert_element_user(PROPERTY_QNAME[0], i);
            return target;
        }
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorder addNewBorder() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorder target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorder)get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
