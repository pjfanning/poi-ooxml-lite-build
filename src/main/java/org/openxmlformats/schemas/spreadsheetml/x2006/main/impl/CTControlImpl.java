...
public class CTControlImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.spreadsheetml.x2006.main.CTControl {
    ...
    private static final QName[] PROPERTY_QNAME = {
        new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "controlPr"),
        new QName("", "shapeId"),
     ...
     */
    @Override
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTControlPr getControlPr() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTControlPr target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTControlPr)get_store().find_element_user(PROPERTY_QNAME[0], 0);
     ...
     */
    @Override
    public void setControlPr(org.openxmlformats.schemas.spreadsheetml.x2006.main.CTControlPr controlPr) {
        generatedSetterHelperImpl(controlPr, PROPERTY_QNAME[0], 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
     ...
     */
    @Override
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTControlPr addNewControlPr() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTControlPr target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTControlPr)get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
