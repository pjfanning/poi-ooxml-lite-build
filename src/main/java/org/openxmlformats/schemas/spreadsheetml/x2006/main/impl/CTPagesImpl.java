...
public class CTPagesImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.spreadsheetml.x2006.main.CTPages {
    ...
    private static final QName[] PROPERTY_QNAME = {
        new QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "page"),
        new QName("", "count"),
    };
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTPCDSCPage[] getPageArray() {
        return getXmlObjectArray(PROPERTY_QNAME[0], new org.openxmlformats.schemas.spreadsheetml.x2006.main.CTPCDSCPage[0]);
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTPCDSCPage getPageArray(int i) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTPCDSCPage)get_store().find_element_user(PROPERTY_QNAME[0], i);
            if (target == null) {
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTPCDSCPage insertNewPage(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTPCDSCPage target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTPCDSCPage)get_store().insert_element_user(PROPERTY_QNAME[0], i);
            return target;
        }
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTPCDSCPage addNewPage() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTPCDSCPage target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTPCDSCPage)get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
