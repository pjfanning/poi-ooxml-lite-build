...
public class CTOlapPrImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.spreadsheetml.x2006.main.CTOlapPr {
    ...
    private static final QName[] PROPERTY_QNAME = {
        new QName("", "local"),
        new QName("", "localConnection"),
        new QName("", "localRefresh"),
        new QName("", "sendLocale"),
        new QName("", "rowDrillCount"),
        new QName("", "serverFill"),
        new QName("", "serverNumberFormat"),
        new QName("", "serverFont"),
        new QName("", "serverFontColor"),
    };
     ...
     */
    @Override
    public org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring xgetLocalConnection() {
        synchronized (monitor()) {
            check_orphaned();
     ...
     */
    @Override
    public void xsetLocalConnection(org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring localConnection) {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring target = null;
            target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXstring)get_store().find_attribute_user(PROPERTY_QNAME[1]);
