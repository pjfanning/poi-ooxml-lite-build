...
public class CTSdtRunImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtRun {
    ...
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRun getSdtContent() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRun)get_store().find_element_user(PROPERTY_QNAME[2], 0);
            return (target == null) ? null : target;
        }
    }
    ...
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRun addNewSdtContent() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRun target = null;
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRun)get_store().add_element_user(PROPERTY_QNAME[2]);
            return target;
        }
    }
