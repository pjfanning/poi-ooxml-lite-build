...
public class CTSdtRowImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtRow {
    ...
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRow getSdtContent() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRow)get_store().find_element_user(PROPERTY_QNAME[2], 0);
            return (target == null) ? null : target;
        }
    }
    ...
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRow addNewSdtContent() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRow target = null;
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRow)get_store().add_element_user(PROPERTY_QNAME[2]);
            return target;
        }
    }
