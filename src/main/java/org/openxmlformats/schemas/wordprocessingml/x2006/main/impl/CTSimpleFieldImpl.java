 ...
 */
public class CTSimpleFieldImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSimpleField {
    private static final long serialVersionUID = 1L;

    public CTSimpleFieldImpl(org.apache.xmlbeans.SchemaType sType) {
        super(sType);
    }
    ...
    private static final QName[] PROPERTY_QNAME = {
        ...
        new QName("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "instr"),
     ...
     */
    @Override
    public org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STString xgetInstr() {
        synchronized (monitor()) {
            check_orphaned();
     ...
     */
    @Override
    public void setInstr(java.lang.String instr) {
        synchronized (monitor()) {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(PROPERTY_QNAME[35]);
     ...
     */
    @Override
    public void xsetInstr(org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STString instr) {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STString target = null;
            target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STString)get_store().find_attribute_user(PROPERTY_QNAME[35]);
    ...
    public org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STOnOff xgetFldLock() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STOnOff)get_store().find_attribute_user(PROPERTY_QNAME[36]);
            return target;
        }
    }
    ...
    public void xsetFldLock(org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STOnOff fldLock) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STOnOff)get_store().find_attribute_user(PROPERTY_QNAME[36]);
            if (target == null) {
                target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STOnOff)get_store().add_attribute_user(PROPERTY_QNAME[36]);
            }
            target.set(fldLock);
        }
    }
