...
public class CTSaveThroughXsltImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSaveThroughXslt {
    ...
    private static final QName[] PROPERTY_QNAME = {
        ...
        new QName("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "solutionID"),
    };
     ...
     */
    @Override
    public org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STString xgetSolutionID() {
        synchronized (monitor()) {
            check_orphaned();
     ...
     */
    @Override
    public void xsetSolutionID(org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STString solutionID) {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STString target = null;
            target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STString)get_store().find_attribute_user(PROPERTY_QNAME[1]);
