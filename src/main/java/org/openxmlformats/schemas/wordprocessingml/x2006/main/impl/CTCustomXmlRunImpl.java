...
public class CTCustomXmlRunImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.wordprocessingml.x2006.main.CTCustomXmlRun {
    ...
    public org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXmlName xgetElement() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXmlName)get_store().find_attribute_user(PROPERTY_QNAME[36]);
            return target;
        }
    }
    ...
    public void xsetElement(org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXmlName element) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXmlName)get_store().find_attribute_user(PROPERTY_QNAME[36]);
            if (target == null) {
                target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STXmlName)get_store().add_attribute_user(PROPERTY_QNAME[36]);
            }
            target.set(element);
        }
    }
