 ...
 */
public class STTrueFalseBlankImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STTrueFalseBlank {
    private static final long serialVersionUID = 1L;

    public STTrueFalseBlankImpl(org.apache.xmlbeans.SchemaType sType) {
        super(sType, false);
    }

    protected STTrueFalseBlankImpl(org.apache.xmlbeans.SchemaType sType, boolean b) {
        super(sType, b);
    }
}
