...
public class CTPosHImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.CTPosH {
    ...
    public org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.STAlignH.Enum getAlign() {
        synchronized (monitor()) {
            ...
            return (target == null) ? null : (org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.STAlignH.Enum)target.getEnumValue();
        }
    }
    ...
    public org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.STAlignH xgetAlign() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.STAlignH)get_store().find_element_user(PROPERTY_QNAME[0], 0);
            return target;
        }
    }
    ...
    public void xsetAlign(org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.STAlignH align) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.STAlignH)get_store().find_element_user(PROPERTY_QNAME[0], 0);
            if (target == null) {
                target = (org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.STAlignH)get_store().add_element_user(PROPERTY_QNAME[0]);
            }
            target.set(align);
        }
    }
    ...
    public org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.STRelFromH.Enum getRelativeFrom() {
        synchronized (monitor()) {
            ...
            return (target == null) ? null : (org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.STRelFromH.Enum)target.getEnumValue();
        }
    }
    ...
    public org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.STRelFromH xgetRelativeFrom() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.STRelFromH)get_store().find_attribute_user(PROPERTY_QNAME[2]);
            return target;
        }
    }
    ...
    public void xsetRelativeFrom(org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.STRelFromH relativeFrom) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.STRelFromH)get_store().find_attribute_user(PROPERTY_QNAME[2]);
            if (target == null) {
                target = (org.openxmlformats.schemas.drawingml.x2006.wordprocessingDrawing.STRelFromH)get_store().add_attribute_user(PROPERTY_QNAME[2]);
            }
