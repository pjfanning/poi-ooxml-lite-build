...
public class CTStyleMatrixReferenceImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.main.CTStyleMatrixReference {
    ...
    public org.openxmlformats.schemas.drawingml.x2006.main.STStyleMatrixColumnIndex xgetIdx() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.main.STStyleMatrixColumnIndex)get_store().find_attribute_user(PROPERTY_QNAME[6]);
            return target;
        }
    }
    ...
    public void xsetIdx(org.openxmlformats.schemas.drawingml.x2006.main.STStyleMatrixColumnIndex idx) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.main.STStyleMatrixColumnIndex)get_store().find_attribute_user(PROPERTY_QNAME[6]);
            if (target == null) {
                target = (org.openxmlformats.schemas.drawingml.x2006.main.STStyleMatrixColumnIndex)get_store().add_attribute_user(PROPERTY_QNAME[6]);
            }
            target.set(idx);
        }
    }
