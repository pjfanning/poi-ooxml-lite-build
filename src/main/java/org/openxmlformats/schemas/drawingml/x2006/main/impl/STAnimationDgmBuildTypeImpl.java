 ...
 */
public class STAnimationDgmBuildTypeImpl extends org.apache.xmlbeans.impl.values.XmlUnionImpl implements org.openxmlformats.schemas.drawingml.x2006.main.STAnimationDgmBuildType, org.openxmlformats.schemas.drawingml.x2006.main.STAnimationBuildType, org.openxmlformats.schemas.drawingml.x2006.main.STAnimationDgmOnlyBuildType {
    private static final long serialVersionUID = 1L;

    public STAnimationDgmBuildTypeImpl(org.apache.xmlbeans.SchemaType sType) {
        super(sType, false);
    }

    protected STAnimationDgmBuildTypeImpl(org.apache.xmlbeans.SchemaType sType, boolean b) {
        super(sType, b);
    }
}
