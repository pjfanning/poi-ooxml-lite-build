...
public class CTScRgbColorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.main.CTScRgbColor {
    ...
    public org.openxmlformats.schemas.drawingml.x2006.main.STPercentage xgetR() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.main.STPercentage)get_store().find_attribute_user(PROPERTY_QNAME[28]);
            return target;
        }
    }
    ...
    public void xsetR(org.openxmlformats.schemas.drawingml.x2006.main.STPercentage r) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.main.STPercentage)get_store().find_attribute_user(PROPERTY_QNAME[28]);
            if (target == null) {
                target = (org.openxmlformats.schemas.drawingml.x2006.main.STPercentage)get_store().add_attribute_user(PROPERTY_QNAME[28]);
            }
            target.set(r);
        }
    }
