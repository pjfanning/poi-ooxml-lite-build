...
public class CTBarChartImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.chart.CTBarChart {
    ...
    private static final QName[] PROPERTY_QNAME = {
        ...
        new QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "overlap"),
    ...
    public org.openxmlformats.schemas.drawingml.x2006.chart.CTOverlap getOverlap() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.chart.CTOverlap)get_store().find_element_user(PROPERTY_QNAME[6], 0);
            return (target == null) ? null : target;
        }
    }
    ...
    public void setOverlap(org.openxmlformats.schemas.drawingml.x2006.chart.CTOverlap overlap) {
        generatedSetterHelperImpl(overlap, PROPERTY_QNAME[6], 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public org.openxmlformats.schemas.drawingml.x2006.chart.CTOverlap addNewOverlap() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.drawingml.x2006.chart.CTOverlap target = null;
            target = (org.openxmlformats.schemas.drawingml.x2006.chart.CTOverlap)get_store().add_element_user(PROPERTY_QNAME[6]);
            return target;
        }
    }
    ...
    public org.openxmlformats.schemas.drawingml.x2006.chart.CTChartLines[] getSerLinesArray() {
        return getXmlObjectArray(PROPERTY_QNAME[7], new org.openxmlformats.schemas.drawingml.x2006.chart.CTChartLines[0]);
    }
    ...
    public org.openxmlformats.schemas.drawingml.x2006.chart.CTChartLines getSerLinesArray(int i) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.chart.CTChartLines)get_store().find_element_user(PROPERTY_QNAME[7], i);
            if (target == null) {
                throw new IndexOutOfBoundsException();
            }
            return target;
    ...
    public void setSerLinesArray(int i, org.openxmlformats.schemas.drawingml.x2006.chart.CTChartLines serLines) {
        generatedSetterHelperImpl(serLines, PROPERTY_QNAME[7], i, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_ARRAYITEM);
    }
    ...
    public org.openxmlformats.schemas.drawingml.x2006.chart.CTChartLines insertNewSerLines(int i) {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.drawingml.x2006.chart.CTChartLines target = null;
            target = (org.openxmlformats.schemas.drawingml.x2006.chart.CTChartLines)get_store().insert_element_user(PROPERTY_QNAME[7], i);
            return target;
        }
    }
    ...
    public org.openxmlformats.schemas.drawingml.x2006.chart.CTChartLines addNewSerLines() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.drawingml.x2006.chart.CTChartLines target = null;
            target = (org.openxmlformats.schemas.drawingml.x2006.chart.CTChartLines)get_store().add_element_user(PROPERTY_QNAME[7]);
            return target;
        }
    }
