...
public class CTRotXImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.chart.CTRotX {
    ...
    public org.openxmlformats.schemas.drawingml.x2006.chart.STRotX xgetVal() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.chart.STRotX)get_store().find_attribute_user(PROPERTY_QNAME[0]);
            if (target == null) {
                target = (org.openxmlformats.schemas.drawingml.x2006.chart.STRotX)get_default_attribute_value(PROPERTY_QNAME[0]);
            }
            return target;
        }
    }
    ...
    public void xsetVal(org.openxmlformats.schemas.drawingml.x2006.chart.STRotX val) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.chart.STRotX)get_store().find_attribute_user(PROPERTY_QNAME[0]);
            if (target == null) {
                target = (org.openxmlformats.schemas.drawingml.x2006.chart.STRotX)get_store().add_attribute_user(PROPERTY_QNAME[0]);
            }
            target.set(val);
        }
    }
