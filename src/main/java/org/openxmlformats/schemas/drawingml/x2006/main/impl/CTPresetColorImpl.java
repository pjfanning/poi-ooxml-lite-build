...
public class CTPresetColorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.main.CTPresetColor {
    ...
    public org.openxmlformats.schemas.drawingml.x2006.main.STPresetColorVal.Enum getVal() {
        synchronized (monitor()) {
            ...
            return (target == null) ? null : (org.openxmlformats.schemas.drawingml.x2006.main.STPresetColorVal.Enum)target.getEnumValue();
        }
    }
    ...
    public org.openxmlformats.schemas.drawingml.x2006.main.STPresetColorVal xgetVal() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.main.STPresetColorVal)get_store().find_attribute_user(PROPERTY_QNAME[28]);
            return target;
        }
    }
    ...
    public void xsetVal(org.openxmlformats.schemas.drawingml.x2006.main.STPresetColorVal val) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.main.STPresetColorVal)get_store().find_attribute_user(PROPERTY_QNAME[28]);
            if (target == null) {
                target = (org.openxmlformats.schemas.drawingml.x2006.main.STPresetColorVal)get_store().add_attribute_user(PROPERTY_QNAME[28]);
            }
            target.set(val);
        }
    }
