...
public class CTSystemColorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.main.CTSystemColor {
    ...
    public org.openxmlformats.schemas.drawingml.x2006.main.STSystemColorVal.Enum getVal() {
        synchronized (monitor()) {
            ...
            return (target == null) ? null : (org.openxmlformats.schemas.drawingml.x2006.main.STSystemColorVal.Enum)target.getEnumValue();
        }
    }
    ...
    public org.openxmlformats.schemas.drawingml.x2006.main.STSystemColorVal xgetVal() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.main.STSystemColorVal)get_store().find_attribute_user(PROPERTY_QNAME[28]);
            return target;
        }
    }
    ...
    public void xsetVal(org.openxmlformats.schemas.drawingml.x2006.main.STSystemColorVal val) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.main.STSystemColorVal)get_store().find_attribute_user(PROPERTY_QNAME[28]);
            if (target == null) {
                target = (org.openxmlformats.schemas.drawingml.x2006.main.STSystemColorVal)get_store().add_attribute_user(PROPERTY_QNAME[28]);
            }
            target.set(val);
        }
    }
     ...
     */
    @Override
    public org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STHexColorRGB xgetLastClr() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STHexColorRGB target = null;
            target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STHexColorRGB)get_store().find_attribute_user(PROPERTY_QNAME[29]);
            return target;
        }
    }
     ...
     */
    @Override
    public void xsetLastClr(org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STHexColorRGB lastClr) {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STHexColorRGB target = null;
            target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STHexColorRGB)get_store().find_attribute_user(PROPERTY_QNAME[29]);
            if (target == null) {
                target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STHexColorRGB)get_store().add_attribute_user(PROPERTY_QNAME[29]);
            }
            target.set(lastClr);
        }
    }
